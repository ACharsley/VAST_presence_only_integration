...
# This code builds the OMs of the simulation study.
...
if(task_id==3){scenario <- "OM_1c"}
if(task_id==4){scenario <- "OM_1d"}
if(task_id==5){scenario <- "OM_2a"}
if(task_id==6){scenario <- "OM_2b"}
if(task_id==7){scenario <- "OM_2c"}
if(task_id==8){scenario <- "OM_2d"}
if(task_id==9){scenario <- "OM_3a"}
if(task_id==10){scenario <- "OM_3b"}
if(task_id==11){scenario <- "OM_3c"}
if(task_id==12){scenario <- "OM_3d"}
if(task_id==13){scenario <- "OM_4a"}
if(task_id==14){scenario <- "OM_4b"}
if(task_id==15){scenario <- "OM_4c"}
if(task_id==16){scenario <- "OM_4d"}
...
# 1. Set data input
Data_inp <- VAST_input_data[[scenario]]


# 2. Set covariate input
covariate_df <- VAST_input_data$covariate_data
