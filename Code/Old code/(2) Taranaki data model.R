...
# 1. Set data input
Data_inp <- VAST_input_data$`Taranaki data`$Data_Geostat

# 2. Set covariate input
X_gctp <- VAST_input_data$`Taranaki data`$X_gctp
X_itp <- VAST_input_data$`Taranaki data`$X_itp
